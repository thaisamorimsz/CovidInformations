...
def main():
    ...
    if app_mode == "Mundo":
        ...
        opcoes_selectbox_mundo_linha = st.selectbox('Escolha a informação que deseja visualizar', [
            'Total de casos',
            'Novos casos',
        ...
        opcoes_radio_mapa_mundo = st.radio(
            'Escolhas as informações que deseja visualizar no mapa abaixo', ['Casos', 'Mortes', 'Testes', 'Vacinações'])
        ...
        estado = st.sidebar.selectbox(
            "Estado", ['Todos'] + lista_estados['state_name'].to_list())

        if estado == 'Todos':

            opcoes_selectbox_linha_brasil = st.selectbox('Escolha a informação que deseja visualizar', [
                'Casos atuais',
                'Casos confirmados',
                'Casos diários',
            ...
            brasil.brasil_linha(lista_estados, estado,
                                opcoes_selectbox_linha_brasil)
            ...
            brasil.brasil_mapa(lista_estados, estado,
                               opcoes_selectbox_mapa_brasil)
        else:
            ...
            brasil.brasil_estados(lista_estados, estado,
                                  opcoes_selectbox_mapa_estado)
